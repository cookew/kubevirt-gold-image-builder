...
variable "kernel_args" {
  default = "inst.noverifyssl inst.geoloc=0 vga=795 hostname=rocky-linux10-gold inst.repo=https://dl.rockylinux.org/pub/rocky/10/BaseOS/x86_64/os/ inst.addrepo=appstream,https://dl.rockylinux.org/pub/rocky/10/AppStream/x86_64/os/"
